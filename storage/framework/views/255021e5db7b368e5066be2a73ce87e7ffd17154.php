...
<div class="row text-center">
    ...
    <img class="wr-top-30" width="85%" src="<?php echo URL::asset('forestage/user/img/member-center-text.png?v=0.0.1'); ?>" alt="">
    <img id="to-bind" class="wr-top-30 wr-bottom-20" width="55%" src="<?php echo URL::asset('forestage/user/img/member-center-button.png?v=0.0.1'); ?>" alt="">
</div>
</body>
<script>
    $(function () {
        $("#to-bind").on("click",function () {
            $(this).attr("src", "<?php echo URL::asset('forestage/user/img/member-center-button-01.png?v=0.0.1'); ?>");
        })
    })
</script>
</html><?php /**PATH /mnt/hgfs/www/zpp-Server4.0/resources/views/web/user/member-center.blade.php ENDPATH**/ ?>