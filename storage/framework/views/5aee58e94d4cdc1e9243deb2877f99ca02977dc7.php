        ...
        <div class="box-body">
          <form id="js-form" action="<?php echo URL::to('admin/sys-notice'); ?>" >
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="title" maxlength="30" placeholder="输入标题" value="">
            </div>
            <div class="form-group">
              <label for="subtitle">内容*：</label>
              <input type="text" class="form-control" name="content" maxlength="90" placeholder="输入内容" value="">
            </div>
            <div class="form-group">
              <label for="url">开始通知时间*：</label>
              <input class="form-control" id="start-at" name="start_at" type="text" value="<?php echo date('Y-m-d H:i:s', time()); ?>">
            </div>
            <div class="form-group">
              <label for="litpic">结束通知时间*：</label>
              <input class="form-control" id="end-at" name="end_at" type="text" value="<?php echo date('Y-m-d H:i:s', time()); ?>">
            </div>
            <div class="form-group">
              ...
              <?php for($i = 0; $i < 24; $i++): ?>
                <label class="checkbox-inline" style="margin-left: 0px; margin-right: 5px;">
                  <input type="checkbox" checked="checked" name="hour[]" value="<?php echo sprintf("%02d",$i); ?>"><?php echo sprintf("%02d",$i); ?>
            ...
            <div class="form-group">
              ...
              <label class="radio-inline">
                <input type="radio" name="client" checked="checked" value="">不限
              </label>
              <label class="radio-inline">
                <input type="radio" name="client" value="pp">《找跑跑版》
              </label>
              <label class="radio-inline">
                <input type="radio" name="client" value="zpp">《跑跑骑手版》
              </label>
            </div>
            <div class="form-group">
...
<?php echo $__env->make('admin/layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /mnt/hgfs/www/zpp-Server4.0/resources/views/admin/sys-notice/new.blade.php ENDPATH**/ ?>