...
<body style="background: #fcfcfc !important;">
<div class="text-center">
    <img src="<?php echo URL::asset('forestage/classroom/img/classroom.gif?v=0.0.1'); ?>" alt="" width="100%">
</div>
</body>
</html><?php /**PATH /mnt/hgfs/www/zpp-Server4.0/resources/views/web/public/classroom/index.blade.php ENDPATH**/ ?>