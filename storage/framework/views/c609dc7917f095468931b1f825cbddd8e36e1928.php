...
<div class="row text-center wr-top-20">
    <form id="js-form" action="<?php echo URL::to('login'); ?>">
        <ul>
            ...
            <li>
                <img id="js-img" style="cursor: pointer;" data-src="<?php echo URL::to('captcha'); ?>">
            </li>
            <li><input type="submit" value="登录"> <a href="<?php echo URL::to('register'); ?>">注册用戶</a></li>
        </ul>
    </form>
</div>
<script>
...
</html><?php /**PATH /mnt/hgfs/group/server/resources/views/web/public/login.blade.php ENDPATH**/ ?>