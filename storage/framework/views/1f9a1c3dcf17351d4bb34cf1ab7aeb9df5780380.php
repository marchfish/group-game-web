...
<div class="row wr-paginate" style="color: #222222">
    <?php echo paging($paginate->currentPage(), $paginate->lastPage(), URL::to('/web/group/account'), Request::all()); ?>
...
</html><?php /**PATH /mnt/hgfs/www/zpp-Server4.0/resources/views/web/group/account/index.blade.php ENDPATH**/ ?>