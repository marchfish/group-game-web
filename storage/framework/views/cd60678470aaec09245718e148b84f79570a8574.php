...
<div style="background: #515884;height: 195px;">
    ...
    <div class="text-center wr-top-20 single wr-padding-bottom-50 wr-padding-top-20">
        <h2 class="wr-top-30">￥<?php echo rmb($data['salary']); ?><span class="wr-meta">元</span></h2>
...
<div class="row wr-top-65" style="vertical-align: middle">
    <div class="wr-top-20 clearfix" style="padding: 0 6%;">
        ...
        <span class="history-link" style="float: right;color: #B2B2B3;font-size: 12pt">查看结算历史<img style="margin-left: 6px;" src="<?php echo URL::asset('forestage/group/img/chevron.png?v=0.0.1'); ?>" alt="" width="5px"></span>
    </div>
    <div class="wr-top-15 wr-bottom-20 wr-content-bg-fff">
        ...
        <div class="row wr-padding-top-20">
            <div style="float: left">
                <img src="<?php echo $row->avatar; ?>" alt="" width="57px" height="57px">
            </div>
            <div class="text-left" style="height: 57px;position: relative">
                <div class="wr-center-left text-left" style="left:75px;">
                    <h4 class="wr-content-bg-fff-h4"><?php echo $row->realname; ?></h4>
                    <span class="wr-content-bg-fff-span">应结算：￥<?php echo rmb($row->salary); ?>元</span>
                </div>
            </div>
        </div>
...
</html><?php /**PATH /mnt/hgfs/www/zpp-Server4.0/resources/views/web/group/settlement/index.blade.php ENDPATH**/ ?>