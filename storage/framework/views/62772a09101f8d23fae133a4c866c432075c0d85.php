...
<div style="background: #515884;height: 220px;">
    ...
    <div class="text-center wr-top-50 single wr-padding-bottom-50 wr-padding-top-20">
        <h2 class="wr-top-30">￥<?php echo rmb($data['group_pay_fee'] + $data['ordinary_pay_fee']); ?><span class="wr-meta">元</span></h2>
   ...
   <div class="wr-line wr-top-15 wr-bottom-20"></div>
    <div class="clearfix" style="padding: 0 6%;color: #353537;">
        <div class="col-xs-6" style="position: relative;height: 200px;">
            ...
            <div class="wr-mask">
                <span class="wr-center" style="color: #B2B2B3;font-size: 11pt">￥<?php echo rmb($data['group_pay_fee'] + $data['ordinary_pay_fee']); ?></span>
            </div>
        </div>
...
</html><?php /**PATH /mnt/hgfs/www/zpp-Server4.0/resources/views/web/group/account/analysis.blade.php ENDPATH**/ ?>