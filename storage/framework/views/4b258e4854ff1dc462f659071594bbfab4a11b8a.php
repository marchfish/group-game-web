...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo URL::asset('forestage/public/swiper-4.5.0/css/swiper.min.css'); ?>">
    ...
    <script type="text/javascript" src="<?php echo URL::asset('forestage/public/swiper-4.5.0/js/swiper.min.js'); ?>"></script>
</head>
<style>
h1,h2,h3,h4,h5,p {
    margin: 0;
...
<div class="gradual-bg">
    <div class="container" style="padding-top: 35px">
        <div class="row">
            <div class="col-xs-2">
                <img src="<?php echo $data['my_level']['icon']; ?>" alt="" width="80px" height="80px">
            </div>
            <div class="col-xs-9" style="margin-top: 22px;margin-left: 22px">
            <h3><?php echo $data['my_level']['name']; ?></h3>
                <div style="color: #fff;font-size: 13pt">打败<span style="color: #F9808A"><?php echo $data['my_level']['ko'] . '%'; ?></span>的骑手</div>
            </div>
        </div>
            ...
            <div class="col-xs-10 col-xs-offset-1" style="position: relative">
                <div class="progress">
                    <div class="progress-bar" role="progressbar" aria-valuenow="60"
                         aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $data['my_level']['percentage']; ?>;position: relative">
                        <div class="bubble <?php echo $data['my_level']['percentage'] =='0%' ? 'percentage' : ''; ?>">
                            <div style="font-size: 14pt;padding-top: 6px"><?php echo $data['my_level']['score']; ?></div>
                            <div style="margin-top: -1px">经验值</div>
                            <span class="caret"></span>
                            <div class="triangle_border_right">
                                <span></span>
                            </div>
                            <div class="run-man <?php echo $data['my_level']['percentage'] =='0%' ? 'hide' : ''; ?>">
                                <img src="<?php echo URL::asset('forestage/pp-user/img/runman.png?v=0.0.1'); ?>" alt="" width="35px">
                            </div>
                        </div>
                    </div>
                    <div class="origin-left" style="margin-left: -73px">
                        <?php echo $data['my_level']['name']; ?>

                    </div>
                </div>
                <div style="height: 5px;width: 100px;position: absolute;right: -19%;top:0;background: #000"></div>
                <div class="origin-right">
                    <?php echo $data['my_level']['next_name']; ?>

                </div>
            </div>
        </div>
        <div class="row text-center" style="margin: 20px 0;">
            <?php if($data['my_level']['level'] != 'MAX'): ?>
                <h3 style="margin-bottom: 5px">再获得<span style="color: #F9808A"><?php echo $data['my_level']['next_score'] - $data['my_level']['score']; ?></span>经验可升<span style="color: #F9808A"><?php echo $data['my_level']['next_name']; ?></span></h3>
            <?php else: ?>
...
<div class="container" style="color: #585858">
    ...
    <div class="box-body no-padding" style="margin-left: 3%">
        <table class="table text-center">
            ...
            <?php $__currentLoopData = $data['level_standard']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td style="text-align: left;color: #4F5785"><?php echo $row->score; ?></td>
                    <td style="color: #585858"><?php echo $row->name; ?></td>
                    <td><img src="<?php echo $row->icon; ?>" alt="" width="60px" height="60px"></td>
                </tr>
...
<?php /**PATH /mnt/hgfs/www/zpp-Server4.0/resources/views/web/pp-user/level/index.blade.php ENDPATH**/ ?>