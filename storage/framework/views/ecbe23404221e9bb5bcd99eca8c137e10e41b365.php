...
<head>
  ...
  <script type="text/javascript" src="<?php echo URL::asset('forestage/public/qrcode-1.0.0/jquery.qrcode.min.js'); ?>"></script>
</head>
<body style="background: #F7F7FA">
<?php if(isset($data)): ?>
  <div class="row wr-padding-bottom-20">
    <div class="text-center" style="background: url('<?php echo URL::asset('forestage/group/img/bg-01.png?v=0.0.1'); ?>');background-size: cover;">
      <div class="wr-top-30 wr-bottom-20">
        <img style="border-radius: 148px" src="<?php echo empty($data->logo) ? URL::asset('forestage/group/img/default-logo.jpg?v=0.0.1') : $data->logo; ?>" alt="" width="100px" height="100px">
      </div>
      <p class="text-center wr-font-20-515 wr-margin-05" style="font-weight: bold"><?php echo $data->name ?? '- -'; ?></p>
    </div>
  </div>
  <div class="wr-stat-header wr-top-20 wr-border-radius-15 text-center row wr-margin-05 wr-shadow" style="color: #222222;background: #fff;">
    <div class="col-xs-3" style="height: 110px;">
      <div class="wr-run-01 wr-line-03 wr-top-32">
        <div class="wr-font-13-515" style="margin-bottom: 4px"><?php echo $data->realname ?? '- -'; ?></div>
        <span class="wr-font-10-515">公司法人</span>
      </div>
    </div>
    <div class="col-xs-6" style="height: 110px; position: relative;">
      <div class="wr-run-01 wr-line-03 wr-top-32">
        <div class="wr-font-13-515" style="margin-bottom: 4px"><?php echo isset($data->created_at) ? substr($data->created_at, 0, 10 ) : '- -'; ?></div>
        <span class="wr-font-10-515">注册时间</span>
      </div>
    </div>
    <div class="col-xs-3" style="height: 110px">
      <div class="wr-run-01 wr-top-32">
        <div class="wr-font-13-515" style="margin-bottom: 4px"><?php echo $data->count ?? '- -'; ?></div>
  ...
  <div class="wr-border-radius-15 text-left row wr-margin-05 wr-padding-05" style="color: #222222;background: #515884;margin-top: 20px;padding-bottom: 30px;">
    <div class="row wr-top-20">
      <div style="float: left">
        <img style="border-radius: 100px;" src="<?php echo empty($data->logo) ? URL::asset('forestage/group/img/default-logo.jpg?v=0.0.1') : $data->logo; ?>" alt="" width="40px" height="40px">
      </div>
  ...
  <div class="row wr-padding-bottom-40 text-center">
    <div class="wr-top-20 wr-bottom-20">
      <img src="<?php echo URL::asset('forestage/group/img/logo.png?v=0.0.1'); ?>" alt="" width="60px" height="60px">
    </div>
...
</html><?php /**PATH /mnt/hgfs/www/zpp-Server4.0/resources/views/web/group/index.blade.php ENDPATH**/ ?>