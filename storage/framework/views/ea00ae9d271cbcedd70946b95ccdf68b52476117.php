...
<div style="background: #515884;height: 220px;">
    ...
    <div class="text-center wr-top-50 single wr-padding-bottom-50 wr-padding-top-20">
        ...
        <span style="color: #B2B2B3;font-size: 15pt">共<?php echo $data['count']; ?>单</span>
    </div>
    <div class="wr-table">
        <div id="account" class="text-center wr-top-10 wr-table-title">流水明细</div>
        <div id="account-analysis" class="text-center wr-top-10 wr-table-title wr-active-01" style="left: 110px">流水分析</div>
    </div>
</div>
   ...
   <div class="wr-line wr-top-15 wr-bottom-20"></div>
    <div class="clearfix" style="padding: 0 6%;color: #353537;">
        <div class="col-xs-6" style="position: relative;height: 200px;">
            ...
            <div class="wr-mask">
                <span class="wr-center" style="color: #B2B2B3;font-size: 11pt">￥<?php echo rmb($data['group_pay_fee'] + $data['ordinary_pay_fee']  + $data['share_amount']); ?></span>
            </div>
        </div>
        <div class="col-xs-4" style="float: right;height: 200px; padding-top: 12%">
            <div class="text-left spot1 wr-bottom-10" style="position: relative;">
                <h3 class="wr-pie-h3">公司客户单</h3>
                <span class="wr-pie-span">￥<?php echo rmb($data['group_pay_fee']); ?></span>
            </div>
            <div class="text-left spot2 wr-bottom-10" style="position: relative;">
                <h3 class="wr-pie-h3">普通用户单</h3>
                <span class="wr-pie-span">￥<?php echo rmb($data['ordinary_pay_fee']); ?></span>
            </div>
            <div class="text-left spot3 wr-bottom-10" style="position: relative;">
                <h3 class="wr-pie-h3">分享奖励金</h3>
                <span class="wr-pie-span">￥<?php echo rmb($data['share_amount']); ?></span>
            </div>
        </div>
    </div>
...
<div class="row wr-top-15 wr-content-header">
    <div class="wr-top-20 clearfix" style="padding: 0 6%;">
        ...
        <span style="float: right;color: #B2B2B3;font-size: 12pt">单位：<?php echo $date_month != '' && $date_month > 0 ? '月' : '日'; ?></span>
    </div>
    <div class="wr-line wr-top-15 wr-bottom-20"></div>
...
<script>
    ...
    $(function () {
        ...
        $('.wr-date-month').on('click', function () {
            window.location.href="/web/pp/account/analysis?date_month=" + $(this).data('month') + '&' + url;
        })
    })
    ...
    $(function () {
        ...
        chart.setOption(<?php echo json_encode($echarts1); ?>);
    });
    ...
    $(function () {
        ...
        chart.setOption(<?php echo json_encode($echarts2); ?>);
    });
...
</html><?php /**PATH /mnt/hgfs/www/zpp-Server4.0/resources/views/web/pp-user/account/analysis.blade.php ENDPATH**/ ?>