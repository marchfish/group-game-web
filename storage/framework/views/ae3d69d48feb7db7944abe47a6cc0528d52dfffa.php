...
<div style="background: #515884;">
    ...
    <div class="row wr-padding-top-20 wr-padding-bottom-20" style="position: relative;margin-left: 4%">
        <div class="wr-flex-center">
            <img src="<?php echo URL::asset('forestage/stat/img/man.png?v=0.0.1'); ?>" alt="" width="18px" height="18px">
            <span class="wr-content-title-fff">人数：<?php echo $data['count']; ?>人</span>
            <img style="margin-left: 10%;" src="<?php echo URL::asset('forestage/stat/img/money.png?v=0.0.1'); ?>" alt="" width="18px" height="18px">
        ...
        <div class="wr-content-bg-fff">
            <div class="row wr-top-30">
                <div style="float: left">
                    <img style="border-radius: 10px;" src="<?php echo $row->avatar; ?>" alt="" width="62px" height="62px">
                </div>
...
</html><?php /**PATH /mnt/hgfs/www/zpp-Server4.0/resources/views/web/group/settlement/detailed.blade.php ENDPATH**/ ?>