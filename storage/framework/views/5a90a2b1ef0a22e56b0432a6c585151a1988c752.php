...
<div class="container">
    <div class="row agreement">
        <p>1.微信收款码可方便您通过通过收款码向顾客收取垫付资金，代购款项资金收取等操作。</p>
        <p>2.请上传您本人的微信收款码图片。</p>
        <p>3.微信收款码图片生成请参考微信客户端的收款码生成教程。</p>
    </div>
</div>
</body>
</html><?php /**PATH /mnt/hgfs/www/zpp-Server4.0/resources/views/web/public/agreement/wq-payment-code.blade.php ENDPATH**/ ?>