...
<div style="background: #515884;height: 195px;">
    ...
    <div class="text-center wr-top-20 single wr-padding-bottom-50 wr-padding-top-20">
        ...
        <span style="color: #353537;font-size: 13pt">总收入</span>
    </div>
</div>
<div class="row wr-top-115" style="background: #fff;vertical-align: middle">
    ...
    <div class="wr-bottom-60 wr-content" style="padding: 0 6%;color: #353537;">
        <?php $__currentLoopData = $paginate->items(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="row wr-top-10 wr-bottom-20 wr-item">
                <span class="col-xs-8 wr-content-left">分享奖励金</span>
                <span class="col-xs-4 wr-content-right">￥<?php echo rmb($item->amount); ?>元</span>
            </div>
...
<div class="row wr-paginate" style="color: #222222">
    <?php echo paging($paginate->currentPage(), $paginate->lastPage(), URL::to('/web/pp/account/income'), Request::all()); ?>
...
<script>
    ...
    $(function () {
        ...
        $('.wr-date-month').on('click', function () {
            window.location.href="/web/pp/account/income?date_month=" + $(this).data('month') + '&' + url;
        })
    })
...
</html><?php /**PATH /mnt/hgfs/www/zpp-Server4.0/resources/views/web/pp-user/account/income.blade.php ENDPATH**/ ?>