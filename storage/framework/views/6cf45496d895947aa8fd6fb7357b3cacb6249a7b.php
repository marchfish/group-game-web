...
<div style="background: #515884;height: 195px;">
    ...
    <div class="text-center wr-top-20 single wr-padding-bottom-30 wr-padding-top-20">
        ...
        <div class="row wr-top-20 wr-flex">
            ...
            <span class="wr-item-01">额</span>
            <hr class="wr-hr" />
            <span class="wr-item-03"><?php echo rmb($data['salary']); ?></span>
            <span class="wr-item-03">元</span>
            <?php if($data['salary'] > 0): ?>
...
<div class="row wr-top-210" style="vertical-align: middle">
    ...
    <?php endif; ?>
    <div class="wr-button-01 text-center <?php echo ($data['deposit'] - $data['salary']) >= $data['cash_min'] ? '' : 'wr-bg-color-afa'; ?>">
        <?php echo ($data['deposit'] - $data['salary']) >= $data['cash_min'] ? '申请提现' : '满' . bcdiv($data['cash_min'], 100, 0) . '元可提现'; ?>
...
</html><?php /**PATH /mnt/hgfs/www/zpp-Server4.0/resources/views/web/group/withdraw/index.blade.php ENDPATH**/ ?>