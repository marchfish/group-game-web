        ...
        <div class="box-body">
          <form id="js-form" action="{!! URL::to('admin/sys-notice') !!}" >
            ...
            <div class="form-group">
              ...
              <input class="form-control" id="start-at" name="start_at" type="text" value="{!! date('Y-m-d H:i:s', time()) !!}">
            </div>
            <div class="form-group">
              <label for="litpic">结束通知时间*：</label>
              <input class="form-control" id="end-at" name="end_at" type="text" value="{!! date('Y-m-d H:i:s', time()) !!}">
            </div>
            <div class="form-group">
              ...
              @for($i = 0; $i < 24; $i++)
                <label class="checkbox-inline" style="margin-left: 0px; margin-right: 5px;">
                  <input type="checkbox" checked="checked" name="hour[]" value="{!! sprintf("%02d",$i) !!}">{!! sprintf("%02d",$i) !!}
                </label>
              @endfor
            </div>
            <div class="form-group">
