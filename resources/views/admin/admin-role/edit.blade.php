        ...
        <div class="box-body">
          <form id="js-form" class="form-horizontal" action="{!! URL::to('admin/admin_role') !!}">
            ...
            <div class="form-group">
              ...
              <div class="col-lg-9">
                <input id="name" name="name" type="text" class="form-control" value="{{ $role->name }}" autocomplete="off">
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-lg-9">
                <div class="checkbox">
                  <ul>
                    ...
                    <li>
                      <label>
                        <input class="js-parent" name="permissions[]" type="checkbox" value="{!! $permission['id'] !!}" {!! isset($role->permissions[$permission['id']]) ? 'checked' : '' !!}>
                        {!! $permission['name'] !!}
                      </label>
                      ...
                      <ul>
                        ...
                        <li>
                          <label>
                            <input class="js-child" name="permissions[]" type="checkbox" value="{!! $child['id'] !!}" data-parent-id="{!! $child['parent_id'] !!}" {!! isset($role->permissions[$child['id']]) ? 'checked' : '' !!}>
                            {!! $child['name'] !!}
                          </label>
                        </li>
                        @endforeach
