                        ...
                        <table class="table table-striped table-bordered table-hover text-center vertical-align-middle">
                            ...
                            @foreach ($paginate->items() as $row)
                                <tr>
                                    ...
                                    <td>{!! $row->name !!}</td>
                                    <td>
                                        <img style="max-width: 50px;max-height: 50px;" src="{!! $row->logo !!}" alt="">
                                    </td>
                                    <td>{!! $row->city !!}</td>
                                    <td>{!! $row->realname !!}</td>
                                    <td>{!! $row->gu_count !!}</td>
                                    ...
                                    <td>
                                        ...
                                        <a class="js-a-group-disabled" data-group-id="{!! $row->id !!}" href="javascript:;">禁用</a>
                                        |
                                        <a class="js-a-group-disabled" data-group-id="{!! $row->id !!}" href="javascript:;">解禁</a>
                                        |
                                        @endif
                                        <a href='/admin/group/check?group_id={!! $row->id . '&_ref=' . json_encode(Request::all()) !!}'>查看</a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
