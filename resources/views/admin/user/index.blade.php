                            ...
                            <table class="table table-striped table-bordered table-hover text-center vertical-align-middle">
                                ...
                                @foreach ($paginate->items() as $row)
                                    <tr>
                                        <td>{!! $row->id !!}</td>
                                        <td>
                                            <img style="max-width: 50px;max-height: 50px;" src="{!! $row->avatar !!}" alt="">
                                        </td>
                                        <td>{!! $row->nickname !!}</td>
                                        <td>{!! $row->tel !!}</td>
                                        <td></td>
                                        ...
                                        <td>
                                            ...
                                            <a class="js-a-user-disabled" data-user-id="{!! $row->id !!}" href="javascript:;">禁用</a>
                                            |
                                            <a class="js-a-user-disabled" data-user-id="{!! $row->id !!}" href="javascript:;">解禁</a>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
