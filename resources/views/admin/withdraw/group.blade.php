...
@section('content')
    <section class="content">
                            ...
                            <table class="table table-striped table-bordered table-hover text-center vertical-align-middle">
                                ...
                                @foreach ($paginate->items() as $row)
                                    <tr>
                                        ...
                                        <td>
                                            @if($row->status == 150)
                                            <a class="js-a-withdraw-pass" data-group-withdraw-id="{!! $row->id !!}" href="javascript:;">通过</a>
                                            |
                                            <a class="js-a-withdraw-disabled" data-group-withdraw-id="{!! $row->id !!}" href="javascript:;">驳回</a>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
        ...
        <div class="row js-form-disabled hide" style="position: fixed;top: 40%;left: 50%;">
            <div class="box box-primary">
                <div class="box-body">
                    <form id="js-form" action="{!! URL::to('admin/withdraw/group') !!}" >
