        ...
        <div class="box-body">
          <form id="js-form" class="form-horizontal" action="{!! URL::to('admin/admin_account') !!}">
            ...
            <div class="form-group">
              ...
              <div class="col-lg-9">
                <input id="username" name="username" type="text" class="form-control" value="{{ $account->username }}" disabled>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-lg-9">
                <input id="nickname" name="nickname" type="text" class="form-control" value="{{ $account->nickname }}" autocomplete="off">
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-lg-9">
                ...
                <div class="checkbox">
                  <label>
                    <input name="roles[]" type="checkbox" value="{!! $role->id !!}" {!! isset($account->roles[$role->id]) ? 'checked' : '' !!}>
                    {!! $role->name !!}
                  </label>
                </div>
                @endforeach
