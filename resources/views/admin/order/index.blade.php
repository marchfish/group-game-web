                            ...
                            <table class="table table-striped table-bordered table-hover text-center vertical-align-middle">
                                ...
                                @foreach ($paginate->items() as $row)
                                    <tr>
                                        <td>{!! $row->id !!}</td>
                                        <td>{!! $row->no !!}</td>
                                        <td>{!! $row->zpp_name!="" ? $row->zpp_name : ""!!}</td>
                                        <td>{!! $row->zpp_tel !!}</td>
                                        <td>{!! $row->pp_name!="" ? $row->pp_name : "" !!}</td>
                                        <td>{!! $row->pp_tel !!}</td>
                                        <td>{!! $row->created_at !!}</td>
                                        <td>{!! $row->city !!}</td>
                                        <td>{!! rmb($row->pay_fee) !!}</td>
                                        <td>{!! $row->is_quick?'是':"" !!}</td>
                                        <td>
                                            <span>{!! $row->order_status !!}</span>
                                        </td>
                                        <td>
                                            <a href="/admin/order/check?order_id={!! $row->id !!}" target="_blank">详情</a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
