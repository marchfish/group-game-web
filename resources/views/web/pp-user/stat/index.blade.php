...
<div class="row wr-content-header wr-padding-05">
    ...
    <script>
        $(function () {
            ...
            $.ajax({
                type:"get",
                url:"/web/pp/stat/income-trend?{!! build_qs( Request::except(['date_month','date_from','date_to']) ) !!}",
                data:{
...
<div class="row wr-top-20 wr-content-header wr-padding-05">
    ...
    <script>
        $(function () {
            ...
            $.ajax({
                type:"get",
                url:"/web/pp/stat/order?{!! build_qs( Request::except(['date_month','date_from','date_to']) ) !!}",
                data:{
                    date_from: '{!! $data['date_from'] !!}',
                    date_to: '{!! $data['date_to'] !!}',
                    date_month: '{!! $date_month !!}',
...
<script>
    $(function () {
        ...
        $.ajax({
            type:"get",
            url:"/web/pp/stat/order1?{!! build_qs( Request::except(['date_month','date_from','date_to']) ) !!}",
            data:{
                date_from: '{!! $data['date_from'] !!}',
                date_to: '{!! $data['date_to'] !!}',
                date_month: '{!! $date_month !!}',
...
<script>
    $(function () {
        $.ajax({
            type:"get",
            url:"/web/pp/stat/order2?{!! build_qs( Request::except(['date_month','date_from','date_to']) ) !!}",
            data:{
                date_from: '{!! $data['date_from'] !!}',
                date_to: '{!! $data['date_to'] !!}',
                date_month: '{!! $date_month !!}',
