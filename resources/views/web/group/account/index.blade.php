...
<body>
<div style="background: #515884;height: 260px;">
    ...
    <div class="text-center single wr-top-50">
        ...
        <div class="row wr-top-40 wr-flex">
            ...
            <hr class="wr-hr" />
            <span class="wr-item-03">{!! rmb($data['group_pay_fee']) !!}</span>
        ...
        <div class="row wr-top-30 wr-flex wr-bottom-50">
            ...
            <span class="wr-item-01">单</span>
            <hr class="wr-hr" />
            <span class="wr-item-03">{!! rmb($data['ordinary_pay_fee']) !!}</span>
            <span class="wr-item-03">元</span>
        </div>
    </div>
    <div class="wr-table">
        <div id="account-company" class="text-center wr-top-10 wr-table-title wr-active-01">流水明细</div>
        <div id="account-analysis-company" class="text-center wr-top-10 wr-table-title" style="left: 110px">流水分析</div>
    </div>
</div>
    ...
    <div class="wr-bottom-60 wr-content" style="padding: 0 6%;color: #353537;">
        @foreach ($paginate->items() as $item)
            <div class="row wr-top-10 wr-bottom-20 wr-item">
                <span class="col-xs-8 wr-content-left">{!! $item->nickname !!}-跑腿费</span>
                <span class="col-xs-4 wr-content-right">￥{!! rmb($item->pay_fee) !!}元</span>
            </div>
        @endforeach
...
<div class="row wr-paginate" style="color: #222222">
    {!! paging($paginate->currentPage(), $paginate->lastPage(), URL::to('/web/group/account'), Request::all()) !!}
</div>
</body>
<script>
    // 选择统计
    $(function () {
        ...
        $('.wr-date-month').on('click', function () {
            window.location.href="/web/group/account?date_month=" + $(this).data('month') + '&' + url;
        })
    })
